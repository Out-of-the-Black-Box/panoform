  ...
  <div id="app">
    ...
    <section>
      <div class="container">
        ...
        <p class="text-center">
          Note: If you're on iOS, please enable
          <strong>Settings > Safari > Motion & Orientation Access</strong> to
          allow you to view your image in VR mode
        </p>
    ...
    <section class="gray">
      <div class="container">
        ...
        <!-- <main>
          <figure v-for="image in recentImages" v-bind:key="image.name">
            <button v-on:click.prevent="removeImage(image.name)"></button>
        ...
        <div class="grid">
          ...
          >
            <img
              class="card_image"
              :src="image.data"
              v-on:click="setImage(image.data)"
              alt=""
            />
            <div class="card_body flex around">
              <button
                v-on:click.prevent="setImage(image.data)"
                class="button inline"
              >
                View
              </button>
              <button
                v-on:click.prevent="removeImage(image.name)"
                class="button inline"
              >
                Delete
              </button>
...
export default {
  ...
  methods: {
    ...
    removeImage(imageName) {
      this.$store.dispatch("removeRecentImage", imageName);
    }
  }
};
</script>
